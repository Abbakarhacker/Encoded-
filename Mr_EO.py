...
\033[43m\033[1;91m[Programmed By Abubakar eo]
\033[43m\033[1;91m[WhatsApp : +2349138749261
\033[43m\033[1;91m[Facebook : Abdullahi Abubakar
...
#def about():
    ...
    print(yellow+'║'+cyan+'[ Author ]    '+purple+' :[ABBAKAREO] ')
    print(yellow+'║'+cyan+'[ Github ]    '+purple+' :[https://github.com/Abbakarhacker] ')
    print(cyan+' ║[Facebook ] '+purple+' :[abdullahi abubakar]')
    print(cyan+' ║[Email]     '+purple+' :[abbakarzakirai88@gmail.com]\n')
    print('\n[01] Main Menu')
    print('[02] Exit')
...
def obfuscate(VARIABLE_NAME, file_content):
    ...
    for _ in range(int(len(b64_content) / OFFSET) + 1):
        ...
        index += OFFSET
    code += f'exec(__import__("\\x62\\x61\\x73\\x65\\x36\\x34").b64decode({VARIABLE_NAME}.encode("MR_EO/HACKER/MR_EO/HACKER")).decode("MR_EO/HACKER/MR_EO/HACKER"))'
    return code
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system('xdg-open --view  https://www.facebook.com/profile.php?id=100087052866273')
                ret=input(white+"\nENTER TO BACK > "+green)
            main()    
   #         else:
    #   os.system('xdg-open  https://www.facebook.com/profile.php?id=100087052866273')
